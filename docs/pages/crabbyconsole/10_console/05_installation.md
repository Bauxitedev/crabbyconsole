...
1. Copy the `addons` folder from the zip file to your Godot game[^3].
1. In Godot, go to your project settings and enable the `CrabbyConsole` plugin[^2]. 
1. The console is now active. Start your game and press ++tilde++ (tilde) to open the console[^1]:
...
[^3]: If you install CrabbyConsole from the in-editor Asset Store, this will be done automatically.
